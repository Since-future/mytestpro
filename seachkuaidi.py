...
def GenerateXml():
    ...
    ordernode = dom.createElement("RouteRequest")
    # #订单号
    ordernode.setAttribute("tracking_type", "1")
    ordernode.setAttribute("tracking_number", "444501331991")
    ordernode.setAttribute("method_type", "1")
